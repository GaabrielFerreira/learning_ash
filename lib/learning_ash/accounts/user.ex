defmodule LearningAsh.Accounts.User do
  use Ash.Resource,
  ...
  authentication do
    tokens do
      enabled? true
      token_lifetime 12
      token_resource LearningAsh.Accounts.Token
      signing_secret LearningAsh.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender LearningAsh.Accounts.User.Senders.SendPasswordResetEmail
